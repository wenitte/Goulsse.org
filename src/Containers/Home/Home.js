...
function Home() {
    ...
    return (
      ...
      <p style={{lineHeight:"40px", textAlign:"left", margin:"50px"}}>
...
<Link to="/files/goulsse.ttf" target="_blank" download>Download Goulsse font today</Link>
<Link to="/files/Gʋlse.pdf" target="_blank" download>Download the Goulsse Alphabet PDF</Link>
    </div>
    );
  }
